...
impl TryFrom<&PlaidRouterData<&types::PaymentsAuthorizeRouterData>> for PlaidPaymentsRequest  {
    ...
    fn try_from(item: &PlaidRouterData<&types::PaymentsAuthorizeRouterData>) -> Result<Self,Self::Error> {
...
impl From<PlaidPaymentStatus> for enums::AttemptStatus {
    fn from(item: PlaidPaymentStatus) -> Self {
        match item {
            PlaidPaymentStatus::Succeeded => Self::Charged,
            PlaidPaymentStatus::Failed => Self::Failure,
            PlaidPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
impl<F,T> TryFrom<types::ResponseRouterData<F, PlaidPaymentsResponse, T, types::PaymentsResponseData>> for types::RouterData<F, T, types::PaymentsResponseData> {
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(item: types::ResponseRouterData<F, PlaidPaymentsResponse, T, types::PaymentsResponseData>) -> Result<Self,Self::Error> {
        Ok(Self {
